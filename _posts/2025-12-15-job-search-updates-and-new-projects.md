...
<img src="{{ "/assets/images/how-did-we-get-here.jpg" | relative_url }}" alt="How I Got Into This Mess" style="max-width: 15%; height: auto; display: block; margin: 1rem 0;">
### Recap / TLDR
...
## Now What Am I Doing
<img src="{{ "/assets/images/what-are-you-going-to-do.jpg" | relative_url }}" alt="So... What Are You Going To Do About It" style="max-width: 15%; height: auto; display: block; margin: 1rem 0;">
...
<img src="{{ "/assets/images/one-does-not-simply.jpg" | relative_url }}" alt="One Does Not Simply Build An App" style="max-width: 15%; height: auto; display: block; margin: 1rem 0;">
...
Who, Where, When, How...
Honestly, I am doing this for all the reasons and none at all. It popped in my head. About the only thing slowing me down at all, financial cost. And because I know this will go nowhere, I'm going to stab in the dark and say...

If you'd like to support my work, you can [donate via PayPal](https://paypal.me/sfh1980).

<img src="{{ "/assets/images/shameless-plug.png" | relative_url }}" alt="Not Sure If Shameless Plug or Patting Self On Back" style="max-width: 15%; height: auto; display: block; margin: 1rem 0;">